...
본 템플릿은 소프트스퀘어드 서버 교육용 Spring Boot 템플릿 입니다. (2023 ver.)
...
api-server-spring-boot
  ...
  > src.main.java.com.example.idear
    > config
      > secret
...
`com.example.idear` 패키지에는 크게 `config` 폴더, `src` 폴더와 이 프로젝트의 시작점인 `DemoApplication.java`가 있다.
